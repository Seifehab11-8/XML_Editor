...
public class Compression {
    public void start_Compression(String inputFilePath) {

            // TODO Auto-generated method stub
            boolean check;
            Compression c1 = new Compression();

            check = c1.compressXML(inputFilePath);
            if(check)
            {
    ...
    {
        String filePath = String.format("E:\\JavaFxproject\\XML_Editor\\XML_Editor\\First Milestone\\demo\\src\\main\\resources%s.comp", type);
