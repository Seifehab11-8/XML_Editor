...
public class Compression {
	...
	{
		String filePath = String.format("src/main/resourcesXML%s.comp", type);
		String KeyPath = String.format("src/main/resourcesXML_key%s.comp", type);
...
//				System.out.println("Key: " + entry.getKey() + ", Value: " + entry.getValue());
	...
	{
		String filePath = String.format("src/main/resources/Json%s.comp", type);
		String KeyPath = String.format("src/main/resources/Json_key%s.comp", type);
